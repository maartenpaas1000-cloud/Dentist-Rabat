  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <button 
        ...
        className="fixed bottom-6 left-6 z-50 bg-blue-600 text-white p-4 rounded-full shadow-2xl hover:bg-blue-700 transition-all flex items-center justify-center group"
